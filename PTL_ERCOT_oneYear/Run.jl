...
myinputs = load_inputs(mysetup, joinpath(inputs_path,"Elec_files"))

# ### Load H2 inputs if modeling the hydrogen supply chain
myinputs = load_h2_inputs(myinputs, mysetup, joinpath(inputs_path,"H2_files"))

myinputs = load_co2_inputs(myinputs, mysetup, joinpath(inputs_path,"CO2_files"))
